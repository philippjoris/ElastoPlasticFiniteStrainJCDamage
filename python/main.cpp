...
PYBIND11_MODULE(_GMatElastoPlasticFiniteStrainSimo, m)
{
    ...
    // Elastic
    py::class_<GMatTensor::Cartesian3d::Array<0ul>>(sm, "Array0d");
    py::class_<GMatTensor::Cartesian3d::Array<1ul>>(sm, "Array1d");
    py::class_<GMatTensor::Cartesian3d::Array<2ul>>(sm, "Array2d");
    py::class_<GMatTensor::Cartesian3d::Array<3ul>>(sm, "Array3d");

    {
        py::class_<SM::Elastic<0>, GMatTensor::Cartesian3d::Array<0ul>> array0d(sm, "Elastic0d");
        py::class_<SM::Elastic<1>, GMatTensor::Cartesian3d::Array<1ul>> array1d(sm, "Elastic1d");
        py::class_<SM::Elastic<2>, GMatTensor::Cartesian3d::Array<2ul>> array2d(sm, "Elastic2d");
        py::class_<SM::Elastic<3>, GMatTensor::Cartesian3d::Array<3ul>> array3d(sm, "Elastic3d");
...

    {
        ...
        py::class_<SM::LinearHardening<0>, GMatTensor::Cartesian3d::Array<0ul>> array0d(
            sm, "LinearHardening0d");

        py::class_<SM::LinearHardening<1>, GMatTensor::Cartesian3d::Array<1ul>> array1d(
            sm, "LinearHardening1d");

        py::class_<SM::LinearHardening<2>, GMatTensor::Cartesian3d::Array<2ul>> array2d(
            sm, "LinearHardening2d");

        py::class_<SM::LinearHardening<3>, GMatTensor::Cartesian3d::Array<3ul>> array3d(
